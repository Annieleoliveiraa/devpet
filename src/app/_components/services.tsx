         ...
         <div className="container mx-auto px-4">
              ...
              <div className="relative">
                     ...
                     {services.map((item, index) => (
                        ...
                        <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                           ...
                           <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                              ...
                              <a 
                              target='_blank'
                              href={`https://wa.me/556799998800?text=Olá vim pelo site e gostaria de 
                               mais informações sobre ${item.title}`}
                 ...
                 className=' bg-white flex items-center justify-center 
                  rounded-full shadow-lg w-10 h-10 absolute left-3 
                  translate-y-1/2 -translate-x-1/2 top-1/3 z-10'
                  onClick={scrollPrev}
                  >
                 ...
                 <button 
                 className=' bg-white flex items-center justify-center 
                  rounded-full shadow-lg w-10 h-10 absolute -right-6
                  translate-y-1/2 -translate-x-1/2 top-1/3 z-10'
                  onClick={scrollNext}
                  >
