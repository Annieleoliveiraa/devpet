     ...
     <section className="bg-[#FDF6ec] py-16">
      ...
      <div className="relative" data-aos="fade-up-right" data-aos-delay="300">
           ...
           <div className="relative w-full h-[400px] rounded-3xl overflow-hidden">
            ...
            <div className="absolute w-40 h-40 right-4 -bottom-8 border-4 overflow-hidden 
      ...
      <p>
         ...
         unawakened. We believe in it and believe in easy access to 
         things that are for our mind, body and spirit. With a clever
